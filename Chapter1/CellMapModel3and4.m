...
%       thetaX=rand(1,1).*2*pi;           %%%matern
%       Rx=[Rx*cos(thetaX) Rx*sin(thetaX)];  
      U_xx2=[U_xx2 points1PP(1, count1)+sigma*randn];
      U_yy2=[U_yy2 points1PP(2, count1)+sigma*randn];
  end
end
...
axis square
saveas(figure(1), 'Model3_max_power','eps') 
...
set(gca, 'XTick', [], 'YTick', []);     % If Ticks on the axis are not desired
axis square
saveas(figure(2), 'Model4_max_power','eps') 
